...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    'ITabler:brandPython': typeof import('~icons/tabler/brand-python')['default']
    'IVscodeIcons:fileTypePython': typeof import('~icons/vscode-icons/file-type-python')['default']
